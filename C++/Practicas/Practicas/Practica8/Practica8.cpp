...
{
    TFile fileStruct;
    fileStruct.OpenFile(fileStruct.inmainFile,"fichero.txt","r");
    fileStruct.ReadFile(fileStruct.inmainFile);
    fileStruct.CloseFile(fileStruct.inmainFile);

    fileStruct.OpenFile(fileStruct.ofmainFile, "fichero.txt", "w");
    fileStruct.WriteFile(fileStruct.ofmainFile, "hola3");
    fileStruct.CloseFile(fileStruct.ofmainFile);
